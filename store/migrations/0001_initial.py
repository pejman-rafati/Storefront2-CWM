# Generated by Django 5.0.1 on 2024-02-03 16:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('P', 'Pending'), ('C', 'Compelete'), ('F', 'Failed')], default='P', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('choices', models.CharField(choices=[('B', 'bronze'), ('S', 'silver'), ('G', 'gold')], default='B', max_length=1)),
